...
service /sap/opu/odata/sap/API_CHARCATTRIBUTECATALOG_SRV on ep0 {
    ...
    # http:Response (Error)
    resource function get A_CharcAttribSeldCodeSet(int? \$top, int? \$skip, string? \$filter, "allpages"|"none"? \$inlinecount, A_CharcAttribSeldCodeSetOrderByOptions? \$orderby, A_CharcAttribSeldCodeSetSelectOptions? \$select) returns CollectionOfA_CharcAttribSeldCodeSetWrapper|http:Response {
        return {
            "d": {
                "SelectedCodeSetPlant": "1010",
                "SelectedCodeSet": "QUAL01",
                "InspectionSelectedSetStatus": "2",
                "CharcAttribSeldSetCreatedBy": "SAP_USER",
                "CharcAttribSeldSetCrtedOn": "/Date(1552521600000)/",
                "CharcAttribSeldSetLastChgdBy": "",
                "CharcAttribSeldSetLastChgdOn": null
            }
        };
    }
}
