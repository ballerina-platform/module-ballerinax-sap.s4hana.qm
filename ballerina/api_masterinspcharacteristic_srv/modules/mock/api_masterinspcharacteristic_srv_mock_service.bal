...
service /sap/opu/odata/sap/API_MASTERINSPCHARACTERISTIC_SRV on ep0 {
    ...
    # http:Response (Error)
    resource function get A_InspectionSpecification(int? \$top, int? \$skip, string? \$filter, "allpages"|"none"? \$inlinecount, A_InspectionSpecificationOrderByOptions? \$orderby, A_InspectionSpecificationSelectOptions? \$select, A_InspectionSpecificationExpandOptions? \$expand) returns CollectionOfA_InspectionSpecificationWrapper|http:Response {
        return {
            "d": {
                "InspectionSpecification": "ABSMAX",
                "InspectionSpecificationVersion": "1",
                "InspectionSpecificationPlant": "1010",
                "Plant": "1010",
                "ValidityStartDate": "/Date(1552521600000)/",
                "InspectionSpecificationSrchTxt": "QM: ABSORPTION MAXIMUM"
            }
        };
    }
}
