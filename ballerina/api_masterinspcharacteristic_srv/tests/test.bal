...
import sap.s4hana.api_masterinspcharacteristic_srv.mock as _;
...
function testListA_InspectionSpecifications() returns error? {
    CollectionOfA_InspectionSpecificationWrapper listOfInspectionSpecifications = check s4HanaClient->listA_InspectionSpecifications({});
    test:assertTrue(listOfInspectionSpecifications.d !is (), "The Inspection specification is expected to be non-empty.");
}
