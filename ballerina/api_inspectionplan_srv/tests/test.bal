...
function testGetA_InspectionLot() returns error? {
    ...
    test:assertTrue(inspectionplan.d !is (), "The purchasing info record is expected to be non-empty.");
}
...
function testCreateInspectionlot() returns error? {
    ...
    test:assertTrue(createdInspectionPlan is error, "The purchasing info record response expected to be 500");
