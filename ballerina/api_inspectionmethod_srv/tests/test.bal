...
import sap.s4hana.api_inspectionmethod_srv.mock as _;
...
function testListA_InspectionMethods() returns error? {
    CollectionOfA_InspectionMethodWrapper listOfInspectionMethods = check s4HanaClient->listA_InspectionMethods({});
    test:assertTrue(listOfInspectionMethods.d !is (), "The Inspection method is expected to be non-empty.");
}
