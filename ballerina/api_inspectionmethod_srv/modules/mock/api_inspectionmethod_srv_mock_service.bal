...
service /sap/opu/odata/sap/API_INSPECTIONMETHOD_SRV on ep0 {
    ...
    # http:Response (Error)
    resource function get A_InspectionMethod(int? \$top, int? \$skip, string? \$filter, "allpages"|"none"? \$inlinecount, A_InspectionMethodOrderByOptions? \$orderby, A_InspectionMethodSelectOptions? \$select, A_InspectionMethodExpandOptions? \$expand) returns CollectionOfA_InspectionMethodWrapper|http:Response {
        return {
            "d": {
                "InspectionMethod": "SURFACE",
                "InspectionMethodVersion": "1",
                "InspectionMethodPlant": "1010",
                "InspectionMethodValidFromDate": "/Date(1552521600000)/",
                "InspectionMethodSearchField": "SURFACE"
            }
        };
    }
}
